        ...
        <div class="providerAdd">
            <form action="#">
                ...
                <div class="">
                    ...
                    <input type="text" name="name" id="name" placeholder="${goods.name}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="purchasePrice">进价：</label>
                    <input type="text" name="purchasePrice" id="purchasePrice" placeholder="${goods.purchasePrice}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="price">售价：</label>
                    <input type="text" name="price" id="price" placeholder="${goods.price}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="desc">商品描述：</label>
                    <input type="text" name="desc" id="desc" placeholder="${goods.desc}"/>
                    <span></span>
                </div>
                <div>
                    <label for="quantity">商品数量：</label>
                    <input type="text" name="quantity" id="quantity" placeholder="${goods.quantity}"/>
                    <span></span>
                </div>
                <div>
                    <label>商品类型：</label>
                    <input type="radio" name="type" value="1" ${goods.type==1?'checked':''}>食品
                    <input type="radio" name="type" value="2" ${goods.type==2?'checked':''}>日用品
                    <input type="radio" name="type" value="3" ${goods.type==3?'checked':''}>家用电器
                </div>
